...
class FiLM(nn.Module):
    ...
    def __init__(self, embedding_dim, feature_dim):
        ...
        # Use a linear layer which predicts both gamma and beta (shared parameters)
        self.film_projector = nn.Linear(
...
if __name__ == "__main__":
    ...
    cond_embedding = torch.rand(embedding_dim).repeat(batch_size, 1) # Same embedding for all elements of batch
